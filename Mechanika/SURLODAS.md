...
$$
F_s = \mu \cdot K = 0,5 \cdot 0,4905 = 0,2453N
$$
...
$$
s = v_0 \cdot t + \frac {a} {2} \cdot t^2 = 5 \cdot 1,019 + \frac {-4,906} {2} \cdot 1,019^2 = 2,548m
$$
...
$$
F_{t,max} = \mu_t \cdot K = 0,7 \cdot 4,905 = 3,434N
$$
...
$$
F_s = \mu \cdot K = 0,5 \cdot 4,905 = 2,453N
$$
...
$$
a = 2 \cdot 1,547 = 3,094 \frac {m} {s^2}
$$
