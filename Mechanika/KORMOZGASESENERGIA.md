...
$$
E_{\text{h},0} + E_{\text{m},0} = E_{\text{h}} + E_{\text{m}}
$$
...
Azt kapjuk, hogy $h_0$ legalább $\frac{5}{2} = 2,5$-szerese $R$-nek, hogy a test körbe tudjon menni a hurokban. Ekt demonstrálta a videón Walter Lewin is.
...
3. A példában szereplő hullámvasút kocsija ($m = 500\text{ kg}$) a $h_0 = 2,5R$ magasságból indul. A hurok sugara $R = 10\text{ m}$.
...
4. Ugyanez a hullámvasút kocsi ($m = 500\text{ kg}$, $h_0 = 2,5R$, $R = 10\text{ m}$) felér a hurok tetejére.
