...
$$
v_{\text{TKP}} = \frac{m_1 v_1 + m_2 v_2}{m_1 + m_2}
$$
...
$$
v_{\text{TKP}} = \frac{m_1 v_{1,0} + m_2 v_{2,0}}{m_1 + m_2} = v_{\text{TKP},0}
$$
...
Egy $0,1\text{ kg}$ tömegű pont koordinátái méterben $(1; 2)$, sebességvektora $\text{m/s}$-ban $(-1; 3)$. Egy másik, $0,3\text{ kg}$ tömegű pont koordinátái $(4; 6)$.
...
$$
x_{\text{TKP}} = \frac{m_1 x_1 + m_2 x_2}{M} = \frac{0,1 \cdot 1 + 0,3 \cdot 4}{0,4} = \frac{1,3}{0,4} = 3,25\text{ m}
$$

$$
y_{\text{TKP}} = \frac{m_1 y_1 + m_2 y_2}{M} = \frac{0,1 \cdot 2 + 0,3 \cdot 6}{0,4} = \frac{2}{0,4} = 5\text{ m}
$$
...
Behelyettesítve ide $x_{\text{TKP}}$ értékét:

$$
y = 1,3333 \cdot 3,25 + 0,6667 = 5,000 = y_{\text{TKP}}
$$
...
A sebesség számítása (ha $v_{\text{TKP}} = 0$):

$$
v_{\text{TKP},x} = \frac{m_1 v_{1,x} + m_2 v_{2,x}}{M}
$$
...
$$
v_{\text{TKP},y} = \frac{m_1 v_{1,y} + m_2 v_{2,y}}{M}
$$
...
A $0,3\text{ kg}$ tömegű test sebességvektora tehát $(0,3333; -1)\text{ m/s}$ egységben.

## 3. Példa

Egy $100\text{ kg}$ tömegű csónak $10\text{ m}$ hosszú, tömegközéppontja $5\text{ m}$-nél, tehát a hosszúságának felénél van. A csónak állóvízen úszik, mely teljesen nyugodt. Egy $40\text{ kg}$ tömegű fiú átsétál a csónak bal oldali végéből a jobb oldali végébe. Hol van a rendszer tömegközéppontja kezdetben, ha az origó a csónak bal szélénél van, és az $x$ tengely a csónakkal párhuzamosan jobbra mutat? Hol van a tömegközéppont a séta végén? A közegellenállás elhanyagolható. Hol van a csónak tömegközéppontja a séta végén? Mi a fiú $x$ koordinátája ekkor?

$$
x_{\text{TKP},0} = \frac{m_1 x_{1,0} + m_2 x_{2,0}}{M} = \frac{100 \cdot 5 + 40 \cdot 0}{140} \approx 3,571\text{ m}
$$
...
$$
x_{\text{TKP}} = \frac{m_1 x_1 + m_2 x_2}{M} = \frac{100(5 - s) + 40(10 - s)}{140}
$$
...
A csónak tehát $2,857\text{ m}$-t mozdul balra, míg a sétáló fiú $7,143\text{ m}$-t jobbra (a vízhez képest). A csónak tömegközéppontja ekkor $2,143\text{ m}$-nél van.
