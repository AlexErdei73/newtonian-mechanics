...
$$
F_{\text{e},y} = 0 \quad \rightarrow \quad \Delta I_y = 0
$$
...
Egy $0{,}100 \ \text{kg}$ tömegű labda $3{,}00 \ \frac{\text{m}}{\text{s}}$ nagyságú sebességgel tökéletesen rugalmasan ütközik a falnak és visszapattan. A beesési szög $30^\circ$, az ütközés ideje $1{,}00 \ \text{ms}$. Mekkora a falra ható átlagos erő az ütközés alatt?
...
$$
F_{\text{e},x} = \frac{\Delta I_x}{t} = \frac{-0{,}5196}{0{,}001} = -519{,}6 \ \text{N}
$$

A falra ható erő ennek ellenerője (Newton III. törvénye):

$$
K = -F_{\text{e},x} = 519{,}6 \ \text{N}
$$
...
[Egyenlő tömegű testek tökéletesen rugalmas ütközése, amikor a céltárgy nyugalomban van](https://alexerdei73.github.io/physics-engine/project/#2b3c424c-4e99-483b-a26e-c34d7ffa8834)
...
Egyszerűsítve a tömeggel:

$$
\vec{v}_0 = \vec{v}_1 + \vec{v}_2
$$

A kezdősebesség tehát a két végső sebesség vektori összege. Ez annyit jelent, hogy $\vec{v}_1$, $\vec{v}_2$ és $\vec{v}_0$ egy háromszög oldalai, amelynek leghosszabb oldala $\vec{v}_0$.
...
A legutolsó egyenlet nem más, mint a **Pitagorasz-tétel** erre a háromszögre. Ez azt jelenti, hogy a háromszög derékszögű, tehát $\vec{v}_1$ és $\vec{v}_2$ egymásra merőlegesek (amennyiben az ütközés nem centrális).

### Példa

Egy $0{,}100 \ \text{kg}$ tömegű golyó $5{,}00 \ \frac{\text{m}}{\text{s}}$ sebességgel ferdén ütközik tökéletesen rugalmasan egy ugyanolyan tömegű, álló golyóval, és lepattan $4{,}00 \ \frac{\text{m}}{\text{s}}$ sebességgel. Mekkora lesz a kezdetben nyugvó golyó sebessége az ütközés után? A golyók forgása elhanyagolható, tehát pontszerűnek tekinthetők. Mekkora az átlagos erő a golyók között, ha az ütközés ideje $1{,}00 \ \text{ms}$?
...
$$
F_{\text{e}} = \frac{\Delta I_2}{t} = \frac{m \cdot v_2 - 0}{t}
$$

$$
F_{\text{e}} = \frac{0{,}1 \cdot 3}{0{,}001} = \frac{0{,}3}{0{,}001} = 300 \ \text{N}
$$

Tehát **$300{,}0 \ \text{N}$** erő lép fel a golyók között átlagosan az $1 \ \text{ms}$ ütközési idő alatt. Ez a kezdetben nyugvó golyót $3{,}00 \ \frac{\text{m}}{\text{s}}$ sebességre gyorsítja fel.

---

## Feladatok

1. Egy teniszlabda $10{,}0 \ \frac{\text{m}}{\text{s}}$ sebességgel csapódik egy függőleges falnak. A beesési szög (a fal normálisához képest) $45^\circ$. A labda tökéletesen rugalmasan pattan vissza.
    * a) Mekkora a labda sebességváltozásának nagysága ($\Delta v$)?
    * b) Ha a labda tömege $58{,}0 \ \text{g}$ és az érintkezés $5{,}00 \ \text{ms}$-ig tart, mekkora átlagos erőt fejt ki a fal a labdára?
