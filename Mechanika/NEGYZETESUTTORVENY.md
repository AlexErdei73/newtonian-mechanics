...
Most egy derékszögü háromszög területét kell meghatároznunk, melynek derékszögü csúcsa az idő tengelyen (vízszintes tengely) van a t időpontnal. Az egyik befogó tehát $t$, a másik pedig $a \cdot t$. A derékszögü háromszög területe az pont fele a téglalap területének, tehát:
...
$$
s = \frac {a} {2} \cdot t^2 = \frac {0.5 \frac {m} {s^2}} {2} \cdot 16s^2 = 4m
$$
...
A megtett út most a trapéz területe. Ez a terület látjuk, hogy a korábbi derékszögű háromszög területe és egy téglalap területének az összege. A téglalap oldalai $t$ és $v_0$, tehát a területe $v_0 \cdot t$.
...
$$
s = v_0 \cdot t + \frac {a} {2} \cdot t^2 = 3 \cdot 4 + \frac {0.5} {2} \cdot 4^2 = 12 + 0.25 \cdot 16 = 16m
$$
