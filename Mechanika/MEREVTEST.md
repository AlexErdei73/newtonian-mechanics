...
$$
M_1 = Fr \sin \alpha = 60 \cdot 0,3 \cdot \sin (90\degree) = 18 \text{ Nm}
$$



$$
M_2 = Fr \sin \alpha = 60 \cdot 0,3 \cdot \sin (60\degree) = 15,58 \text{ Nm}
$$
...
$$
|M_1| = F_1 k_1 = m g r_1 = 20 \cdot 9,81 \cdot 2 = 392,4 \text{ Nm}
$$



$$
|M_2| = F_2 k_2 = F_2 r_2 = 130 \cdot 3 = 390,0 \text{ Nm}
$$
...
$$
M_{z,1} = -Mg x_{TKP} = -60 \cdot 9,81 \cdot (-1) = 588,6 \text{ Nm}
$$
...
$$
M_{z,2} = -mgx = -80 \cdot 9,81 \cdot x = -784,8x \text{ Nm}
$$
