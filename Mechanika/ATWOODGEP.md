...
1. Az elhanyagolható tömeg azt jelenti, hogy a fonal gyorsításához nem szükséges erő, tehát a végein pontosan ugyanakkora erőt fejt ki. Ha ugyanis a fonal egyenes, meg van feszítve (vavy ilyen darabokra osztható), akkor a gyorsulása a második törvény alapján:
...
Itt $K_1$ és $K_2$ a két végen kifejtett erők, melyer ellentétes irányúak. Ha $m = 0$, akkor:
...
$$
\frac{\Delta v_{1,\text{f}}}{t} = \frac{\Delta v_{2,\text{f}}}{t}
$$
...
$$
F_{\text{s}} = 2K = \frac{4m_1 m_2}{m_1 + m_2}g
$$
