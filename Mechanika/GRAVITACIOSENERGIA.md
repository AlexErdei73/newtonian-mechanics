...
Azt is láttuk, hogy a nehézségi erő a Föld gravitációs vonzásából fakad, melyet a Föld a felszín közeli testekre fejt ki. Láttuk, hogy ez a vonzóerő a távolság négyzetével csökken, tehát a Hold távolságára lévő testre például $3600$-szor kisebb vonzóerővel hat a Föld, mint egy ugyanilyen testre a földfelszín közelében, hiszen a Hold $60$-szor olyan messze van a Föld középpontjától, mint a Föld felszíne.
...
2. A nevezőben $\Delta r$ elhanyagolható $r$ mellett, hiszen sokkal kisebb nála.
...
1. A Naptól a bolygóhoz húzott sugárra merőleges elmozdulás-komponens munkavégzéssel nem jár, hiszen ez az erő irányára merőleges elmozdulás-komponens!
...
A munka negatív, ha $\Delta r > 0$, mivel ellentétes irányú a gravitációs erő és az elmozdulás. A munka pozitív, ha $\Delta r < 0$, mert a bolygó az erő irányába mozdul el. Van-e olyan $E_{\text{g}}$ gravitációs energia, mely úgy változik, hogy
...
Látjuk, hogy ez mindig negatív, hiszen $h \ll R$, de egy adott testre csak egy állandóban ($-mgR$) különbözik a magassági helyzeti energiától ($mgh$). Ez annyit jelent, hogy a helyzeti energia nullaszintje $R$ magasságban, tehát $6\ 370\text{ km}$-nél van nullának választva. A szokásos esetben, amikor a talajszinten van nullának választva a gravitációs energia:

$$
E_{\text{h}} = mgh = E_{\text{g}} + mgR
$$
...
$$
E_{\text{m}} + E_{\text{g}} = E_{\text{m},0} + E_{\text{g},0}
$$
...
Itt az $E$ összenergia ismeretlen, de jegyezzük meg, hogy ez csak a bolygó és a Nap átlagos távolságától függ, nem függ a pálya alakjától sem. Az összefüggés az $E$ energia és az $a$ átlagos távolság között körpályából is megkapható:
...
$$
v_{\text{Nap}} = \sqrt{GM_{\text{Nap}} \frac{2}{r}} = \sqrt{8\pi^2} \approx 8,886\text{ CSE/év} \approx 42,12\text{ km/s}
$$
...
$$
v_{\text{Föld}} = \frac{2\pi r}{T} = \frac{2 \cdot 3,1415 \cdot 1,496 \cdot 10^8}{365,26 \cdot 86\ 400} \approx 29,78\text{ km/s}
$$
...
| Kör | $E = -E_{\text{m}} = \frac{E_{\text{g}}}{2}$ | $a = R$ | [Körpálya](https://alexerdei73.github.io/physics-engine/project/#5f0cba8e-b08a-4f3b-94b6-627d297e388f) |
...
| Hiperbola | $E > 0$ | $a < 0$ | [Hiperbolapálya](https://alexerdei73.github.io/physics-engine/project/#fb3346ec-45d8-4e2f-b03a-07bf897767af) |