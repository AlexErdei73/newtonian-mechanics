...
$$
m_1 + m_2 = \frac {m_2g} {a} = \frac {0,2 \cdot 9,81} {2} = 0,981 kg = 981 g
$$


### Feladatok
1. Mekkora a rendszer mechanikai energiája, ha a gyorsító tömeg $200 g$, és a rendszer $0,5 s$-on át gyorsul? Mitől függ ez a mechanikai energia? Válasszuk a helyzeti energia nullaszintjét az első test magasságában, és kezdetben a második test legyen $-0,1 m$ magasságban!
