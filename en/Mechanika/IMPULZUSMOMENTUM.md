...
3. The moment of inertia of a system consisting of two bodies about a given axis is $\Theta_1$. How does the moment of inertia change if the mass of both bodies is increased threefold ($3m$), and their distance from the axis of rotation is reduced to one-third ($\frac{r}{3}$)? Derive your answer using the formulas based on Example 2!
